...
<li  class="nav-item"><a class="nav-link" href="forloop.php">Simple forloop</a></li>
<li  class="nav-item"><a class="nav-link" href="whiledowhileloop.php">Simple while/dowhile</a></li>
...
<li class="nav-item" ><a class="nav-link" href="stingmanip.php">Simple String Manipulation statement</a></li>
